...
export default function ContactClientPage() {
  ...
  return (
    <>
      <PageHero
        kicker="Partnerships & Engagement"
        title="Partner With Us"
        description="Collaborate with ARDA on relief, resilience and sustainable development programmes across Southwest State and Banadir, Somalia."
        pageKey="contact"
        sectionKey="hero"
      />
